...
function BlogForm(props) {
    ...
    const onNext = () => {
        ...
        let b = document.querySelector(".blogSec")
        let c = document.querySelector(".blogImg")
                ...
                <form className='uploadForm'>
                    ...
                    <div className="postSec">
                        ...
                        <div className="blogSec">
                            ...
                            <textarea name="Caption" id="caption" placeholder='Write a caption...' cols="30" rows="8" maxLength="100000"></textarea>
                        ...
                        <div className="blogImg">
                            <div className="imgBlogSec">
                                ...
                                <label className='uploadBlogBtn' htmlFor="postUpload">Upload</label>
                            </div>
                        </div>
                    </div>
                </form>
